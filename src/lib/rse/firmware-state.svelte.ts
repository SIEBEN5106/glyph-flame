...
export class FirmwareState {
  ...
  async buildImageTree(images: BitmapFileInfo[]) {
    ...
    const CATEGORIES: Record<string, { group: string; label: string }> = {
      ...
      '0012': { group: 'shared', label: 'Boot Animation' },
      '0013': { group: 'shared', label: 'Boot Animation' },
      '0014': { group: 'shared', label: 'Boot Animation' },
      '0015': { group: 'shared', label: 'Boot Animation' },
      '0016': { group: 'shared', label: 'Boot Animation' },
      '0017': { group: 'shared', label: 'Boot Animation' },
      '0018': { group: 'shared', label: 'Boot Animation' },
      '0019': { group: 'shared', label: 'Boot Animation' },
      '0020': { group: 'shared', label: 'Boot Animation' },
      '0021': { group: 'shared', label: 'Boot Animation' },
      '0022': { group: 'shared', label: 'Boot Animation' },
      '0023': { group: 'shared', label: 'Boot Animation' },
      '0024': { group: 'shared', label: 'Boot Animation' },
      '0025': { group: 'shared', label: 'Boot Animation' },
      '0026': { group: 'shared', label: 'Boot Animation' },
      '0027': { group: 'shared', label: 'Boot Animation' },
      '0028': { group: 'shared', label: 'Boot Animation' },
      '0029': { group: 'shared', label: 'Boot Animation' },
      '0030': { group: 'shared', label: 'Boot Animation' },
      '0031': { group: 'shared', label: 'Boot Animation' },
      '0032': { group: 'shared', label: 'Boot Animation' },
      '0033': { group: 'shared', label: 'Boot Animation' },
      '0034': { group: 'shared', label: 'Boot Animation' },
      '0035': { group: 'shared', label: 'Boot Animation' },
      '0036': { group: 'shared', label: 'Boot Animation' },
      '0037': { group: 'shared', label: 'Boot Animation' },
      '0038': { group: 'shared', label: 'Boot Animation' },
      '0039': { group: 'shared', label: 'Boot Animation' },
      '0040': { group: 'shared', label: 'Boot Animation' },
      '0041': { group: 'shared', label: 'Boot Animation' },
      '0042': { group: 'shared', label: 'Boot Animation' },
      '0043': { group: 'shared', label: 'Boot Animation' },
      '0044': { group: 'shared', label: 'Boot Animation' },
      '0045': { group: 'shared', label: 'Close Animation' },
      '0046': { group: 'shared', label: 'Updating Screen' },
      '0047': { group: 'shared', label: 'Updating Screen' },
      '0049': { group: 'shared', label: 'Battery Charging' },
      '0050': { group: 'shared', label: 'Battery Charging' },
      '0051': { group: 'shared', label: 'Battery Charging' },
      '0052': { group: 'shared', label: 'Battery Charging' },
      '0053': { group: 'shared', label: 'Battery Charging' },
      '0067': { group: 'shared', label: 'Clean Background' },
      // ── Light Theme ──
      '0098': { group: 'light', label: 'Now Playing - VU Watch' },
      '0099': { group: 'light', label: 'USB Connected' },
      ...
      '0108': { group: 'light', label: 'Yes / No Dialog' },
      '0109': { group: 'light', label: 'Yes / No Dialog' },
      '0110': { group: 'light', label: 'Battery Low' },
      '0111': { group: 'light', label: 'Now Playing - Magnetic' },
      '0156': { group: 'light', label: 'Item List' },
      '0157': { group: 'light', label: 'Item List' },
      '0179': { group: 'light', label: 'Loading Bar' },
      '0180': { group: 'light', label: 'Loading Bar' },
      '0181': { group: 'light', label: 'Loading Bar' },
      '0182': { group: 'light', label: 'Loading Bar' },
      '0183': { group: 'light', label: 'Clean Background' },
      '0233': { group: 'light', label: 'Now Playing - Magnetic' },
      '0234': { group: 'light', label: 'Now Playing - Magnetic' },
      '0235': { group: 'light', label: 'Now Playing - Magnetic' },
      '0236': { group: 'light', label: 'Now Playing - Magnetic' },
      '0237': { group: 'light', label: 'Now Playing - Magnetic' },
      '0238': { group: 'light', label: 'Now Playing - Magnetic' },
      '0239': { group: 'light', label: 'Now Playing - Magnetic' },
      '0240': { group: 'light', label: 'Now Playing - Magnetic' },
      '0241': { group: 'light', label: 'Now Playing - Magnetic' },
      '0242': { group: 'light', label: 'Now Playing - Magnetic' },
      '0243': { group: 'light', label: 'Now Playing - Magnetic' },
      '0244': { group: 'light', label: 'Now Playing - Magnetic' },
      '0245': { group: 'light', label: 'Now Playing - Magnetic' },
      '0246': { group: 'light', label: 'Now Playing - Magnetic' },
      '0247': { group: 'light', label: 'Now Playing - Magnetic' },
      '0248': { group: 'light', label: 'Status Bar' },
      '0249': { group: 'light', label: 'Status Bar' },
      '0250': { group: 'light', label: 'Status Bar' },
      '0251': { group: 'light', label: 'Status Bar' },
      '0252': { group: 'light', label: 'Volume Control' },
      '0253': { group: 'light', label: 'Volume Control' },
      '0254': { group: 'light', label: 'Volume Control' },
      '0255': { group: 'light', label: 'Volume Control' },
      '0256': { group: 'light', label: 'Volume Control' },
      '0257': { group: 'light', label: 'Volume Control' },
      '0315': { group: 'light', label: 'Date Time Select' },
      '0383': { group: 'light', label: 'Now Playing - Album Art' },
      '0384': { group: 'light', label: 'Now Playing - Album Art' },
      '0410': { group: 'light', label: 'Now Playing - DAC' },
      '0411': { group: 'light', label: 'Now Playing - DAC' },
      '0417': { group: 'light', label: 'DAC Rotate Animation' },
      '0418': { group: 'light', label: 'DAC Rotate Animation' },
      '0419': { group: 'light', label: 'DAC Rotate Animation' },
      '0420': { group: 'light', label: 'DAC Rotate Animation' },
      '0421': { group: 'light', label: 'DAC Rotate Animation' },
      '0422': { group: 'light', label: 'DAC Rotate Animation' },
      '0423': { group: 'light', label: 'DAC Rotate Animation' },
      '0424': { group: 'light', label: 'DAC Rotate Animation' },
      '0425': { group: 'light', label: 'DAC Rotate Animation' },
      '0426': { group: 'light', label: 'DAC Rotate Animation' },
      '0427': { group: 'light', label: 'DAC Rotate Animation' },
      '0428': { group: 'light', label: 'DAC Rotate Animation' },
      '0429': { group: 'light', label: 'DAC Rotate Animation' },
      '0430': { group: 'light', label: 'DAC Rotate Animation' },
      '0431': { group: 'light', label: 'DAC Rotate Animation' },
      '0432': { group: 'light', label: 'DAC Rotate Animation' },
      // ── Dark Theme ──
      '0461': { group: 'dark', label: 'Now Playing - VU Watch' },
      '0462': { group: 'dark', label: 'USB Connected' },
      ...
      '0471': { group: 'dark', label: 'Yes / No Dialog' },
      '0472': { group: 'dark', label: 'Yes / No Dialog' },
      '0473': { group: 'dark', label: 'Battery Low' },
      '0474': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0519': { group: 'dark', label: 'Item List' },
      '0520': { group: 'dark', label: 'Item List' },
      '0542': { group: 'dark', label: 'Loading Bar' },
      '0543': { group: 'dark', label: 'Loading Bar' },
      '0544': { group: 'dark', label: 'Loading Bar' },
      '0545': { group: 'dark', label: 'Loading Bar' },
      '0546': { group: 'dark', label: 'Clean Background' },
      '0596': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0597': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0598': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0599': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0600': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0601': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0602': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0603': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0604': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0605': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0606': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0607': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0608': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0609': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0610': { group: 'dark', label: 'Now Playing - Magnetic' },
      '0611': { group: 'dark', label: 'Status Bar' },
      '0612': { group: 'dark', label: 'Status Bar' },
      '0613': { group: 'dark', label: 'Status Bar' },
      '0614': { group: 'dark', label: 'Status Bar' },
      '0615': { group: 'dark', label: 'Volume Control' },
      '0616': { group: 'dark', label: 'Volume Control' },
      '0617': { group: 'dark', label: 'Volume Control' },
      '0618': { group: 'dark', label: 'Volume Control' },
      '0619': { group: 'dark', label: 'Volume Control' },
      '0620': { group: 'dark', label: 'Volume Control' },
      '0678': { group: 'dark', label: 'Date Time Select' },
      '0746': { group: 'dark', label: 'Now Playing - Album Art' },
      '0747': { group: 'dark', label: 'Now Playing - Album Art' },
      '0773': { group: 'dark', label: 'Now Playing - DAC' },
      '0774': { group: 'dark', label: 'Now Playing - DAC' },
      '0780': { group: 'dark', label: 'DAC Rotate Animation' },
      '0781': { group: 'dark', label: 'DAC Rotate Animation' },
      '0782': { group: 'dark', label: 'DAC Rotate Animation' },
      '0783': { group: 'dark', label: 'DAC Rotate Animation' },
      '0784': { group: 'dark', label: 'DAC Rotate Animation' },
      '0785': { group: 'dark', label: 'DAC Rotate Animation' },
      '0786': { group: 'dark', label: 'DAC Rotate Animation' },
      '0787': { group: 'dark', label: 'DAC Rotate Animation' },
      '0788': { group: 'dark', label: 'DAC Rotate Animation' },
      '0789': { group: 'dark', label: 'DAC Rotate Animation' },
      '0790': { group: 'dark', label: 'DAC Rotate Animation' },
      '0791': { group: 'dark', label: 'DAC Rotate Animation' },
      '0792': { group: 'dark', label: 'DAC Rotate Animation' },
      '0793': { group: 'dark', label: 'DAC Rotate Animation' },
      '0794': { group: 'dark', label: 'DAC Rotate Animation' },
      '0795': { group: 'dark', label: 'DAC Rotate Animation' },
    };
    ...
    for (const cat of Object.values(CATEGORIES)) {
      groupLabels[cat.group]?.add(cat.label);
    }
    const buckets: Record<string, typeof images> = { other: [] };
      ...
      children: [
        {
          ...
          label: '📦 Shared',
          type: 'folder' as const,
          children: [...groupLabels['shared']].sort().map(label =>
            makeFolder(`shared-${label}`, label, buckets[`shared::${label}`])
        ...
        },
        {
          ...
          label: '☀️ Light Theme',
          type: 'folder' as const,
          children: [...groupLabels['light']].sort().map(label =>
            makeFolder(`light-${label}`, label, buckets[`light::${label}`])
          ).filter(f => f.children.length > 0),
        },
        {
          id: 'cat-dark',
          label: '🌙 Dark Theme',
          type: 'folder' as const,
          children: [...groupLabels['dark']].sort().map(label =>
            makeFolder(`dark-${label}`, label, buckets[`dark::${label}`])
          ).filter(f => f.children.length > 0),
        },
